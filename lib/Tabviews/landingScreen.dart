...
import 'package:rehber_builders/Tabviews/Activities/delayed_activity.dart';
import 'package:rehber_builders/Tabviews/Add_Material/material_screen.dart';
import 'package:rehber_builders/Tabviews/ChatView/chat_search.dart';
import 'package:rehber_builders/Tabviews/Dashboards/customerDashboard.dart';
import 'package:rehber_builders/Tabviews/Dashboards/dashboard.dart';
import 'package:rehber_builders/Tabviews/ProjectList/project_screen.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: ImageIcon(AssetImage(IconImages.material_Box), size: 26),
              label: ''),
          BottomNavigationBarItem(
              icon: ImageIcon(AssetImage(IconImages.payment_circle), size: 26),
              label: ''),
          BottomNavigationBarItem(
              icon: ImageIcon(AssetImage(IconImages.home), size: 38),
              label: ''),
          BottomNavigationBarItem(
              icon: ImageIcon(AssetImage(IconImages.beat_circle), size: 26),
              label: ''),
          BottomNavigationBarItem(
              icon: ImageIcon(AssetImage(IconImages.pdt_to_buy), size: 26),
              label: ''),
        ],
      ),
    );
